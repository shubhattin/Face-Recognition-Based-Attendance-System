                    ...
                    # 6.2.2 / Face cnt increase: 0->1, 0->2, ..., 1->2, ...
                        ...
                        for k in range(len(faces)):
                            ...
                            for i in range(len(self.face_features_known_list)):
                                ...
                                try:
                                    feat_known = np.array(self.face_features_known_list[i], dtype=float)
                                except Exception:
                            ...
                            sorted_dists = sorted(self.current_frame_face_X_e_distance_list)
                            min_dist = sorted_dists[0]
                            second_dist = sorted_dists[1] if len(sorted_dists) > 1 else 999999999
                            threshold = 0.45
                            margin = 0.03
                            if min_dist < threshold and (second_dist - min_dist) >= margin:
                                ...
                                cnt = self.recognized_consecutive_counts.get(name_rec, 0) + 1
                                ...
                                if cnt >= self.required_consecutive_hits and (now_ts - last_ts) >= self.cooldown_seconds:
